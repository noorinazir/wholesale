<x-app-layout>
    @php
    $emails = \App\Models\GeneratedEmail::with('vendor')->where('status', 'approved')->latest()->paginate(25);
    @endphp

    <x-page-header title="Pending Approval" :back="route('dashboard')" :count="$emails->total() . ' total'" />
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700/50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Approved At</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $email->approved_at?->format('M d, Y H:i') }}</td>
                        <td class="px-4 py-3">
                    ...
                    <tr><td colspan="4" class="px-4 py-8">
                        <x-empty-state icon="clock" title="No pending emails" description="Approved emails waiting to be sent will appear here." />
                    </td></tr>
                    @endforelse
                </tbody>
            </table>
